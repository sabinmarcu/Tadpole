...
(function(/*! Stitch !*/) {
  ...
  Application = (function(_super) {
    ...
    function Application() {
      var data, el, els, root, section, sections, _i, _j, _len, _len1, _ref, _ref1, _resize,
        _this = this;
      root = window;
      ...
      if (document.body.className.indexOf("landing") >= 0) {
        ...
        for (_i = 0, _len = sections.length; _i < _len; _i++) {
          section = sections[_i];
          data += DepMan.render("landing.article", {
            data: DepMan.doc(section),
            title: section
          });
        }
        $("section").html(data);
        $("#ff").click(function() {
          var req, _ref;
          req = (_ref = window.navigator.mozApps) != null ? _ref.install("" + window.location + "manifest.webapp") : void 0;
          req.onsuccess = function() {
            return alert("App Installed!");
          };
          return req.onerror = function() {
            alert("App failed to install!\n Data in console");
            return console.log(req.error.name);
          };
        });
        $("#run").click(function() {
          return window.location = "index.app.html";
        });
        return;
      }
      ...
      document.getElementById("sidebarToggle").addEventListener("click", function() {
        return typeof Client !== "undefined" && Client !== null ? Client.publish("switchMode", "sidebaroff") : void 0;
      });
      document.getElementById("fullScreenToggle").addEventListener("click", function() {
        return typeof Client !== "undefined" && Client !== null ? Client.publish("switchMode", "fullscreen") : void 0;
      });
...
return buf.join("");
...
}}, "views/_list": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      ...
      __out.push(__sanitize(_T("Download")));
    
      __out.push(' ></p></i>\n\t\t\t</li>\n\t\t\t<li id="uploadButton">\n\t\t\t\t<i class="icon-circle-arrow-up"><p ');
    
      __out.push(__sanitize(_T("Upload")));
    
      __out.push(' ></p></i>\n\t\t\t</li>\n\t\t</nav>\n\t</header>\n\t<section></section>\n\t<footer>\n\t\t<nav>\n\t\t\t<li id="saveButton" ng-click="save()">\n\t\t\t\t<i class="icon-ok"><p ');
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/landing.article": function(exports, require, module) {
...
__jade.unshift({ lineno: 3, filename: __jade[0].filename });
buf.push('<a');
buf.push(attrs({ 'href':("#" + (title) + "") }, {"href":true}));
buf.push('>');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 3, filename: __jade[0].filename });
buf.push('<i class="icon-link">');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</i>');
__jade.shift();
