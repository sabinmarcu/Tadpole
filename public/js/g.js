...
(function(/*! Stitch !*/) {
  ...
  Application = (function(_super) {
    ...
    Application.prototype.decideView = function() {
      ...
      this.LoadProgress.progress(31);
      if (landing !== "false") {
        this.LoadProgress.then(this.renderLandingPage, null, Loading.progress).then(this.hookLandingPageStuff, null, Loading.progress).then((function() {
          return Loading.end();
        }), null, null);
      } else {
        this.LoadProgress.then(this.renderBaseline, null, Loading.progress).then(this.dragAndDropHooks, null, Loading.progress).then(this.mobileHooks, null, Loading.progress).then(this.opmlBootstrap, null, Loading.progress).then((function() {
          return Loading.end();
        }), null, null);
      }
      return this.LoadProgress.resolve(true);
    ...
    Application.prototype.hookLandingPageStuff = function() {
      return jQuery("#startapp").click(function() {
        return localStorage.setItem("landing", false);
      });
    };
  ...
  angular.module("Arrow").controller("NGAsideController", function($scope, $rootScope) {
    ...
    $scope.theme = localStorage.getItem("theme") || "bluetheme";
    _ref1 = $scope.themes;
    ...
    $scope.changedTheme = function() {
      return localStorage.setItem("theme", $scope.theme.mime);
    };
    $scope.sidebarstatus = localStorage.getItem("sidebarstatus") || "closed";
    $scope.togglesidebar = function() {
      ...
      return localStorage.setItem("sidebarstatus", $scope.sidebarstatus);
    };
    $scope.activeTab = localStorage.getItem("lastpanel") || TABS.LIST;
    $scope.asidetab = function(whom) {
      $scope.activeTab = TABS[whom];
      return localStorage.setItem("lastpanel", TABS[whom]);
    };
    ...
    return $scope.activateLanding = function() {
      ...
      return localStorage.setItem("landing", $scope.landingpageactive);
    };
  });
  ...
  (function() {
    ...
    Client = (function(_super) {
      ...
      Client.prototype.init = function() {
        ...
        return jQuery("#qrimage").removeClass("hidden");
      };
