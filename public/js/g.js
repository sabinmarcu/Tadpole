...
(function(/*! Stitch !*/) {
  ...
  MainFrameBuffer = (function(_super) {
    ...
    function MainFrameBuffer(buffer, model) {
      ...
      this.Gugu = new (DepMan.classes("GuguFrameBuffer"))(this.model, this);
      this.Aux = new (DepMan.classes("AuxFrameBuffer"))(this.model, this);
      this.Line = new (DepMan.classes("LinesFrameBuffer"))(this.model, this);
    ...
    MainFrameBuffer.prototype.down = function(e) {
      ...
      if (!this.node) {
        ...
        setTimeout(function() {
          if (!_this.isMovement) {
            return _this.model.editNodeModal(node);
          }
        }, 200);
      }
      e.preventDefault();
