...
(function(/*! Stitch !*/) {
  ...
  Application = (function(_super) {
    ...
    Application.prototype.firstTimeInclude = function() {
      ...
      return window.Storage = new (DepMan.helper("Storage"))();
    };
    ...
    Application.prototype.extras = function() {
      ...
      Storage.get("tutorial", function(tut) {
        if (!tut) {
  ...
  angular.module("Arrow").controller("NGAsideController", function($scope, $rootScope) {
    ...
    storage.getItem("landing", function(sets) {
    ...
    return Storage.get("tutorial", function(tut) {
      $scope.tutorialactive = !tut;
      return $scope.activateTutorial = function() {
        Storage.set("tutorial", !$scope.tutorialactive);
        return window.location = window.location;
      };
    });
  });
  ...
  Storage = (function() {
    ...
    Storage.prototype.set = function(item, value) {
      return (this["new"](item)).set(value);
    };
...
QRBitBuffer.prototype = {
  ...
  (function() {
    (function() {
      __out.push('<aside data-intro="This is the settings bar. Moving forward ..." data-step="2" data-position="right">\n\t');
